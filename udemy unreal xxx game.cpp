...
void PrintIntroduction(int Difficulty) {
    ...
    std::cout << "\n\nDear God- just pick three numbers! The Level of Difficulty is: " << Difficulty<< "\n\n";
...
bool PlayGame(int Difficulty) {
    ...
    int GuessSum = FirstNumber + SecondNumber + ThirdNumber;
    int GuessProduct = FirstNumber * SecondNumber * ThirdNumber;
